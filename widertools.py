...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QtCore.QRect(1010, 160, 331, 291))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.cmbCloseRatio.setGeometry(QtCore.QRect(20, 50, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.cmbMaxFacesPerCluster.setGeometry(QtCore.QRect(20, 100, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.cmbMaxFacesPerCluster.setFont(font)
        self.cmbMaxFacesPerCluster.setObjectName("cmbMaxFacesPerCluster")
        self.btnTagSelInv = QtWidgets.QPushButton(self.groupBox)
        self.btnTagSelInv.setGeometry(QtCore.QRect(260, 190, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.label_9.setGeometry(QtCore.QRect(190, 10, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_9.setFont(font)
        self.label_9.setObjectName("label_9")
        self.btnTagSelAll = QtWidgets.QPushButton(self.groupBox)
        self.btnTagSelAll.setGeometry(QtCore.QRect(190, 190, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.btnTagSelAll.setFont(font)
        self.btnTagSelAll.setObjectName("btnTagSelAll")
        self.txtMaxHvsW = QtWidgets.QLineEdit(self.groupBox)
        self.txtMaxHvsW.setGeometry(QtCore.QRect(120, 170, 41, 20))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.txtMaxHvsW.setFont(font)
        self.txtMaxHvsW.setObjectName("txtMaxHvsW")
        self.scrollTags = QtWidgets.QScrollArea(self.groupBox)
        self.scrollTags.setGeometry(QtCore.QRect(190, 30, 131, 151))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 116, 149))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.scrollTags.setWidget(self.scrollAreaWidgetContents)
        self.txtMinHvsW = QtWidgets.QLineEdit(self.groupBox)
        self.txtMinHvsW.setGeometry(QtCore.QRect(120, 140, 41, 20))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.txtMinHvsW.setFont(font)
        self.txtMinHvsW.setObjectName("txtMinHvsW")
        self.label_8 = QtWidgets.QLabel(self.groupBox)
        self.label_8.setGeometry(QtCore.QRect(20, 170, 91, 16))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.txtDatasetSize.setGeometry(QtCore.QRect(120, 260, 51, 20))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.txtOutX.setGeometry(QtCore.QRect(120, 230, 51, 20))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.txtOutY.setGeometry(QtCore.QRect(120, 200, 51, 20))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.txtOutY.setFont(font)
        self.txtOutY.setObjectName("txtOutY")
        self.btnToVoc = QtWidgets.QPushButton(self.groupBox)
        self.btnToVoc.setGeometry(QtCore.QRect(190, 230, 131, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(1010, 20, 341, 101))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.label_13.setGeometry(QtCore.QRect(10, 20, 37, 24))
        font = QtGui.QFont()
        ...
        self.chkAutoload.setGeometry(QtCore.QRect(280, 20, 51, 21))
        ...
        self.btnSaveOriBBoxes.setGeometry(QtCore.QRect(240, 60, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.btnSaveOriBBoxes.setFont(font)
        self.btnSaveOriBBoxes.setObjectName("btnSaveOriBBoxes")
        self.groupBox_3 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_3.setGeometry(QtCore.QRect(1010, 490, 141, 61))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(1150, 490, 201, 61))
        font = QtGui.QFont()
        font.setPointSize(9)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "多框子块数据集配置"))
        ...
        self.label_7.setText(_translate("MainWindow", "边框最小高/宽"))
        ...
        self.label_8.setText(_translate("MainWindow", "边框最大高/宽"))
        self.label_5.setText(_translate("MainWindow", "生成子块数"))
        self.txtDatasetSize.setText(_translate("MainWindow", "300"))
        self.label_4.setText(_translate("MainWindow", "子块高度"))
        self.txtOutX.setText(_translate("MainWindow", "96"))
        self.label_3.setText(_translate("MainWindow", "子块宽度"))
