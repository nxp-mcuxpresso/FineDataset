...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QtCore.QRect(1010, 250, 361, 181))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.cmbMaxObjsPerCluster = QtWidgets.QComboBox(self.groupBox)
        self.cmbMaxObjsPerCluster.setGeometry(QtCore.QRect(180, 80, 61, 21))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        font.setBold(False)
        font.setWeight(50)
        self.cmbMaxObjsPerCluster.setFont(font)
        self.cmbMaxObjsPerCluster.setObjectName("cmbMaxObjsPerCluster")
        ...
        self.txtOutN = QtWidgets.QLineEdit(self.groupBox)
        self.txtOutN.setGeometry(QtCore.QRect(290, 120, 51, 20))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.txtOutN.setFont(font)
        self.txtOutN.setObjectName("txtOutN")
        ...
        self.cmbMinAreaRate.setGeometry(QtCore.QRect(150, 30, 101, 21))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.cmbMaxAreaRate.setGeometry(QtCore.QRect(250, 30, 101, 21))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.chkSkipDirtyPatch = QtWidgets.QCheckBox(self.groupBox)
        self.chkSkipDirtyPatch.setGeometry(QtCore.QRect(10, 150, 261, 21))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        font.setBold(False)
        font.setWeight(50)
        self.chkSkipDirtyPatch.setFont(font)
        self.chkSkipDirtyPatch.setToolTip("")
        self.chkSkipDirtyPatch.setToolTipDuration(200)
        self.chkSkipDirtyPatch.setWhatsThis("")
        self.chkSkipDirtyPatch.setChecked(True)
        self.chkSkipDirtyPatch.setObjectName("chkSkipDirtyPatch")
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(1010, 0, 361, 231))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        ...
        self.label.setGeometry(QtCore.QRect(220, 30, 41, 16))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        ...
        self.chkSkipDirtyImage = QtWidgets.QCheckBox(self.groupBox_2)
        self.chkSkipDirtyImage.setGeometry(QtCore.QRect(10, 200, 261, 21))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        font.setBold(False)
        font.setWeight(50)
        self.chkSkipDirtyImage.setFont(font)
        self.chkSkipDirtyImage.setToolTip("")
        self.chkSkipDirtyImage.setToolTipDuration(200)
        self.chkSkipDirtyImage.setWhatsThis("")
        self.chkSkipDirtyImage.setChecked(True)
        self.chkSkipDirtyImage.setObjectName("chkSkipDirtyImage")
        self.groupBox_3 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_3.setGeometry(QtCore.QRect(1180, 460, 181, 91))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.chkOutHasTmStmp = QtWidgets.QCheckBox(self.groupBox_3)
        self.chkOutHasTmStmp.setGeometry(QtCore.QRect(20, 60, 151, 21))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        font.setBold(False)
        font.setWeight(50)
        self.chkOutHasTmStmp.setFont(font)
        self.chkOutHasTmStmp.setChecked(False)
        self.chkOutHasTmStmp.setObjectName("chkOutHasTmStmp")
        self.groupBox_4 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_4.setGeometry(QtCore.QRect(1180, 560, 191, 101))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(10)
        ...
        self.btnOriImg.setGeometry(QtCore.QRect(130, 20, 51, 31))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        self.btnOriImg.setFont(font)
        self.btnOriImg.setObjectName("btnOriImg")
        self.btnRefreshLabels = QtWidgets.QPushButton(self.groupBox_4)
        self.btnRefreshLabels.setGeometry(QtCore.QRect(10, 60, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        self.btnRefreshLabels.setFont(font)
        self.btnRefreshLabels.setObjectName("btnRefreshLabels")
        self.btnTagSelInv = QtWidgets.QPushButton(self.centralwidget)
        self.btnTagSelInv.setGeometry(QtCore.QRect(1100, 630, 71, 31))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        ...
        self.label_9.setGeometry(QtCore.QRect(1010, 450, 81, 16))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.btnTagSelAll.setGeometry(QtCore.QRect(1010, 630, 71, 31))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        ...
        self.scrollTags.setGeometry(QtCore.QRect(1010, 470, 161, 151))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        ...
        self.btnDelNonCheckedTags.setGeometry(QtCore.QRect(1010, 670, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        self.btnDelNonCheckedTags.setFont(font)
        self.btnDelNonCheckedTags.setObjectName("btnDelNonCheckedTags")
        self.cmbExportDSType = QtWidgets.QComboBox(self.centralwidget)
        self.cmbExportDSType.setGeometry(QtCore.QRect(1100, 720, 171, 22))
        self.cmbExportDSType.setObjectName("cmbExportDSType")
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setGeometry(QtCore.QRect(1010, 720, 91, 20))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.btnExport.setGeometry(QtCore.QRect(1280, 710, 71, 31))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(9)
        ...
        self.menuAboxTool = QtWidgets.QAction(MainWindow)
        self.menuAboxTool.setObjectName("menuAboxTool")
        self.menuSaveConfig = QtWidgets.QAction(MainWindow)
        self.menuSaveConfig.setObjectName("menuSaveConfig")
        self.menuSaveConfigAs = QtWidgets.QAction(MainWindow)
        self.menuSaveConfigAs.setObjectName("menuSaveConfigAs")
        self.menuLoadConfig = QtWidgets.QAction(MainWindow)
        self.menuLoadConfig.setObjectName("menuLoadConfig")
        self.actionAuto_Load_last_Config = QtWidgets.QAction(MainWindow)
        self.actionAuto_Load_last_Config.setCheckable(True)
        self.actionAuto_Load_last_Config.setChecked(True)
        self.actionAuto_Load_last_Config.setObjectName("actionAuto_Load_last_Config")
        self.menuLang_CHS = QtWidgets.QAction(MainWindow)
        self.menuLang_CHS.setCheckable(True)
        self.menuLang_CHS.setChecked(True)
        self.menuLang_CHS.setObjectName("menuLang_CHS")
        self.menuLang_ENG = QtWidgets.QAction(MainWindow)
        self.menuLang_ENG.setCheckable(True)
        self.menuLang_ENG.setObjectName("menuLang_ENG")
        self.menu.addAction(self.menuSaveConfig)
        self.menu.addAction(self.menuSaveConfigAs)
        self.menu.addAction(self.menuLoadConfig)
        ...
        self.menu_3.addAction(self.menuAboxTool)
        self.menu_Language.addAction(self.menuLang_CHS)
        self.menu_Language.addAction(self.menuLang_ENG)
        ...
        MainWindow.setTabOrder(self.cmbMinCloseRate, self.cmbMaxObjsPerCluster)
        MainWindow.setTabOrder(self.cmbMaxObjsPerCluster, self.chkAllowMoreObj)
        MainWindow.setTabOrder(self.chkAllowMoreObj, self.txtOutY)
        MainWindow.setTabOrder(self.txtOutY, self.txtOutX)
        MainWindow.setTabOrder(self.txtOutX, self.txtOutN)
        MainWindow.setTabOrder(self.txtOutN, self.scrollTags)
        ...
        MainWindow.setTabOrder(self.btnTagSelInv, self.btnDelNonCheckedTags)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "合并至少几个邻近物体"))
        ...
        self.chkAllowMoreObj.setText(_translate("MainWindow", "允许更密集"))
        self.chkSkipDirtyPatch.setText(_translate("MainWindow", "只使用长宽比符合约束的物体"))
        ...
        self.chkSkipDirtyImage.setText(_translate("MainWindow", "只读取符合约束的图"))
        ...
        self.chkOutHasTmStmp.setText(_translate("MainWindow", "输出目录有时间戳"))
        self.groupBox_4.setTitle(_translate("MainWindow", "验证子块数据集与工具"))
        ...
        self.btnRefreshLabels.setText(_translate("MainWindow", "刷新标注"))
        ...
        self.label_11.setText(_translate("MainWindow", "导出数据集格式"))
        ...
        self.menu_Language.setTitle(_translate("MainWindow", "语言/Language"))
        self.actiontrain.setText(_translate("MainWindow", "train"))
        self.menuDbgGenMultiForCurrent.setText(_translate("MainWindow", "只在当前图像上生成多框数据集"))
        self.menuDbgGenMultiForCurrent.setShortcut(_translate("MainWindow", "Ctrl+D"))
        self.menuSpecifyImageNdx.setText(_translate("MainWindow", "显示指定的图像..."))
        self.menuSpecifyImageNdx.setShortcut(_translate("MainWindow", "Ctrl+N"))
        self.menuDelNonCheckedTags.setText(_translate("MainWindow", "删除未选中的标签"))
        self.menuAboxTool.setText(_translate("MainWindow", "锚框工具"))
        self.menuAboxTool.setShortcut(_translate("MainWindow", "Ctrl+H"))
        self.menuSaveConfig.setText(_translate("MainWindow", "保存配置"))
        self.menuSaveConfig.setShortcut(_translate("MainWindow", "Ctrl+S"))
        self.menuSaveConfigAs.setText(_translate("MainWindow", "配置另存为..."))
        self.menuSaveConfigAs.setShortcut(_translate("MainWindow", "Ctrl+A"))
        self.menuLoadConfig.setText(_translate("MainWindow", "打开配置"))
        self.menuLoadConfig.setShortcut(_translate("MainWindow", "Ctrl+L"))
        self.actionAuto_Load_last_Config.setText(_translate("MainWindow", "自动打开上次配置"))
        self.menuLang_CHS.setText(_translate("MainWindow", "简体中文"))
        self.menuLang_ENG.setText(_translate("MainWindow", "English"))
